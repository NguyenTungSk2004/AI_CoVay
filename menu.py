...
class Menu:
    def __init__(self, screen, font, allChess, board_sizes, init_variables):
        ...
        self.exit_button = pygame.Rect(450, 320, 100, 50)
    ...
    def draw_player_name_input(self, MyColor):
        pygame.draw.rect(self.screen, MyColor if self.input_active else color.WHITE, self.input_box, 2) 
   ...
   # Hàm vẽ nút thoát
    def draw_exit_button(self):
        exit_button_x = 450  
        pygame.draw.rect(self.screen, color.WHITE, (exit_button_x, 320, 100, 50))
        draw_text('Thoát', self.font, color.BLACK, self.screen, exit_button_x + 10, 325)

    # Hàm vẽ nút chơi
    def draw_play_button(self):
        play_button_x = 250  
        pygame.draw.rect(self.screen, color.WHITE, (play_button_x, 320, 100, 50))  
        draw_text('Chơi', self.font, color.BLACK, self.screen, play_button_x + 25, 325)
